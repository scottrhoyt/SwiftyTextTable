...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  SwiftyTextTable is the Swifty way of generating text tables easy. No more worrying about
  ...
  s.source       = { :git => "https://github.com/scottrhoyt/SwiftyTextTable.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "Source/SwiftyTextTable"
